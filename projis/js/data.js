...
export const PRESETS = [
  ...
  // chassisH = physical height of the chassis box in cm, excluding both the feet below and any lens/mirror
  //            assembly that protrudes above. Used only for drawing. If null, bodyH is used as fallback.
  // feetH    = height of the projector's feet/legs in cm (0 if unknown or negligible).
  //            Used only for drawing feet below the chassis box in floor/pedestal mode.
  //            bodyH already accounts for feet (it is measured from the feet base to lens centre),
  //            so feetH does NOT affect any throw/position calculations.
  ...
  // cMode = color calibration correction factor (real-world brightness vs spec box lumens)
  {id:'eb800f',   name:'Epson EB-800F',              aspectVal:'1.77777778', rMin:.27, rMax:.37, sUp:0,  sDn:0,  vOffset:61,  fixed:false, ks:3,  bodyH:16.08, chassisH:13.4, feetH:1.2,  chassisWidth:45.8, chassisDepth:37.5, lensXOffset:0, lensZOffset:5, dMin:60,  dMax:350,  shiftType:'digital', digitalZoom:true,  shiftCurve:null, ustMirror:true, hMax:0,  lumens:5000, fWide:null, fTele:null, cMode:0.85, note:'Fixed optical ratio (0.27:1). Zoom is digital (cropping).'},
  {id:'ehls100',  name:'Epson EH-LS100',             aspectVal:'1.77777778', rMin:.27, rMax:.37, sUp:0,  sDn:0,  vOffset:61,  fixed:false, ks:3,  bodyH:16.2,  chassisH:18.8, feetH:1.2,  chassisWidth:49.4, chassisDepth:43.7, lensXOffset:0, lensZOffset:5, dMin:45,  dMax:350,  shiftType:'digital', digitalZoom:true,  shiftCurve:null, ustMirror:true, hMax:0,  lumens:4000, fWide:null, fTele:null, cMode:0.85, note:'Fixed optical ratio (0.27:1). Zoom is digital (cropping). Lens recessed 26 mm below chassis top.'},
  {id:'gt1080e',  name:'Optoma GT1080e',             aspectVal:'1.77777778', rMin:.49, rMax:.49, sUp:0,  sDn:0,  vOffset:58,  fixed:true,  ks:40, bodyH:6.0,  chassisH:10.85, feetH:0.55, chassisWidth:31.5, chassisDepth:22.4, lensXOffset:8, lensZOffset:0, dMin:74,  dMax:762,  shiftType:'none',    digitalZoom:false, shiftCurve:null, hMax:0,  lumens:3000, fWide:null, fTele:null, cMode:0.60, note:'Fixed lens (0.49:1). No zoom.'},
  {id:'zh450st',  name:'Optoma ZH450ST',             aspectVal:'1.77777778', rMin:.50, rMax:.50, sUp:0,  sDn:0,  vOffset:58,  fixed:true,  ks:40, bodyH:6.0,  chassisH:10.85, feetH:0.55, chassisWidth:27.4, chassisDepth:21.6, lensXOffset:5, lensZOffset:0, dMin:65,  dMax:762,  shiftType:'none',    digitalZoom:false, shiftCurve:null, hMax:0,  lumens:4200, fWide:null, fTele:null, cMode:0.60, note:'Fixed lens (0.50:1). No zoom.'},
  ...
  {id:'l1050_lu', name:'Epson EB-L1050U + ELPLU03S', aspectVal:'1.6',        rMin:.65, rMax:.78, sUp:67, sDn:67, vOffset:0,   fixed:false, ks:30, bodyH:10.7, chassisH:16.4, feetH:2.5,  chassisWidth:54.5, chassisDepth:43.6, lensXOffset:0, lensZOffset:-8, dMin:93,  dMax:1320, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:24, lumens:5500, fWide:null, fTele:null, cMode:0.85},
  {id:'ml1050st', name:'Optoma ML1050ST+',           aspectVal:'1.6',        rMin:.80, rMax:.80, sUp:0,  sDn:0,  vOffset:50,  fixed:true,  ks:40, bodyH:2.9,  chassisH:5.55, feetH:0.15, chassisWidth:11.2, chassisDepth:12.3, lensXOffset:0, lensZOffset:0, dMin:50,  dMax:400,  shiftType:'none',    digitalZoom:false, shiftCurve:null, hMax:0,  lumens:1000, fWide:null, fTele:null, cMode:0.60, note:'Fixed lens (0.80:1). No zoom. Silicone bumper pads only.'},
  // ELPLW05 ≈ ELPLW06 aperture range (F1.8–2.3); ELPLM08 ≈ ELPLM15 (F1.8–2.35)
  {id:'l1050_lw', name:'Epson EB-L1050U + ELPLW05',  aspectVal:'1.6',        rMin:1.04,rMax:1.46,sUp:67, sDn:67, vOffset:0,   fixed:false, ks:30, bodyH:10.7, chassisH:16.4, feetH:2.5,  chassisWidth:54.5, chassisDepth:43.6, lensXOffset:0, lensZOffset:-5.1, dMin:93,  dMax:1830, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:24, lumens:5500, fWide:1.8,  fTele:2.3,  cMode:0.85},
  ...
  {id:'np525ul',  name:'NEC NP-P525UL',              aspectVal:'1.6',        rMin:1.23,rMax:2.00,sUp:62, sDn:0,  vOffset:50,  fixed:false, ks:30, bodyH:6.1,  chassisH:13.3, feetH:0.8,  chassisWidth:48.0, chassisDepth:40.7, lensXOffset:-13, lensZOffset:2, dMin:84,  dMax:1830, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:24, lumens:5200, fWide:1.5,  fTele:2.1,  cMode:0.85},
  {id:'g6450wu',  name:'Epson EB-G6450WU',           aspectVal:'1.6',        rMin:1.26,rMax:2.30,sUp:67, sDn:67, vOffset:0,   fixed:false, ks:30, bodyH:7.2,  chassisH:15.9, feetH:1.2,  chassisWidth:50.5, chassisDepth:38.2, lensXOffset:0, lensZOffset:2, dMin:93,  dMax:1830, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:23, lumens:4500, fWide:1.65, fTele:2.55, cMode:0.85},
  {id:'tw9000',   name:'Epson EH-TW9000',            aspectVal:'1.77777778', rMin:1.34,rMax:2.87,sUp:96, sDn:96, vOffset:0,   fixed:false, ks:30, bodyH:7.0,  chassisH:12.8, feetH:1.2,  chassisWidth:46.6, chassisDepth:39.5, lensXOffset:0, lensZOffset:3, dMin:200, dMax:1000, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:47, lumens:2400, fWide:2.0,  fTele:3.17, cMode:0.85},
  {id:'l530u',    name:'Epson EB-L530U',             aspectVal:'1.6',        rMin:1.35,rMax:2.20,sUp:50, sDn:50, vOffset:0,   fixed:false, ks:30, bodyH:7.0,  chassisH:13.6, feetH:0.2,  chassisWidth:44.0, chassisDepth:33.9, lensXOffset:0, lensZOffset:2, dMin:86,  dMax:1780, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:24, lumens:5200, fWide:1.5,  fTele:1.7,  cMode:0.85},
  {id:'l690u',    name:'Epson EB-L690U',             aspectVal:'1.6',        rMin:1.35,rMax:2.20,sUp:50, sDn:50, vOffset:0,   fixed:false, ks:30, bodyH:7.0,  chassisH:13.6, feetH:0.2,  chassisWidth:44.0, chassisDepth:34.0, lensXOffset:0, lensZOffset:2, dMin:86,  dMax:1780, shiftType:'optical', digitalZoom:false, shiftCurve:null, hMax:24, lumens:6500, fWide:1.5,  fTele:1.7,  cMode:0.85},
